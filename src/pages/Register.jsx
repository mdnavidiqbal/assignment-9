...
//     e.preventDefault();
//     if (!validatePassword(password)) return alert("Password must have uppercase, lowercase and at least 6 chars.");
//     try {
...
//         <input value={photoURL} onChange={e=>setPhotoURL(e.target.value)} placeholder="Photo URL" className="input input-bordered w-full" />
